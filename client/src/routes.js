...
import GoogleLogin from './components/auth/google_login';
...
import NewExpert from './components/dashboard/new-expert';
...
import UserExpert from './components/dashboard/user-expert';
...
export default (
  <Route path="/" component={App}>
    ...
    <Route path="user-expert" component={RequireAuth(UserExpert)} />
    ...
    <Route path="dashboard">
      ...
      <Route path="new-expert" component={RequireAuth(NewExpert)} />
