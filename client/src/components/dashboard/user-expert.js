...
class UserExpert extends Component {
  constructor(props) {
    super(props);
    this.state = {
      responseMsg:"",
  ...
  handleFormSubmit(formProps) {
     ...
     //var formdata = new FormData(document.getElementById("user_expert"));
     ...
     return axios.post(`${API_URL}/userExpert`, formProps,{
          ...
          <div className="wrapper-sidebar-page">
            <div className="row row-offcanvas row-offcanvas-left">
              ...
              <div className="column col-sm-9 col-xs-11" id="main">
                  <div id="pageTitle">
                    <div className="title">User Expert</div>
                  </div>


                 <form id="user_expert" enctype="multipart/form-data" method="post" 
                 onSubmit={handleSubmit( this.handleFormSubmit.bind(this))}>
                    ...
                    <div className="row form-group">
                      ...
                      <div className="col-md-4 form-group">
                        ...
                        <Field name="expertSubCategories" component={renderFieldexpertSubCategories} type="select" />
                      </div>
...
export default connect(mapStateToProps, { protectedTest, UserExpert })(form(UserExpert));
