...
upload = () =>{  
  ...
  return axios.post(`${API_URL}/upload`,req_array)
   .then((response) => {
   	...
   	console.log('---');
    console.log(response.data.user_data.profileImage);
   	console.log('--1-');
   	this.setState({successmessage:"Profile photo updated successfully!"});
     // location.reload();
   }).catch((error) => {
     console.log(error);
   });
	                  ...
	                  {this.isRole('User', this.userMenu())}
		                 ...
		                 {/* my code to upload image */}
		                 	...
		                 	<div className="expert-img change_image">
																						...
																						{ this.state.profileImage && this.state.profileImage != null && this.state.profileImage != undefined && this.state.profileImage != "" ? <img className="image_view" onClick={()=>{this.triggerFileUpload()}} style={{width:'150px',margin:'10px -10px'}} height="" width="" src={"/src/public/profile_images/"+this.state.profileImage } /> : "" }
                        { this.state.profileImage == null || this.state.profileImage == undefined || this.state.profileImage == "" ? <img className="image_view" style={{width:'150px',margin:'10px -10px'}} src="/src/public/img/profile.png"/>:"" }
																				...
																				<button onClick={()=>{this.upload()}} className="btn btn-default" style={{margin:'5px 15px'}}>Update Image</button>
		                 {/* 

																						<img className="image_view" height="" width=""/>
		                 my code to upload image */}
